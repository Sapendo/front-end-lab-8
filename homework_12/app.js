...
const sortBy = {
    ...
    handleClicks: function() {
        this.$container.on('click', 'li',function() {
            $(this).hasClass('desc') || $(this).hasClass('asc') ? $(this).toggleClass('asc desc') : $(this).addClass('desc');
            let catalog = $(this).attr('id');
            let direction = $(this).attr('class');
            control.sortBy(catalog, direction);
          });
    }
}
